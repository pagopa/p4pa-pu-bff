...
class TaxonomyServiceTypeCodeMapperTest {
  ...
  @Test
  void testMap() {
    it.gov.pagopa.pu.organization.dto.generated.TaxonomyServiceTypeCodeDTO input = new it.gov.pagopa.pu.organization.dto.generated.TaxonomyServiceTypeCodeDTO();
