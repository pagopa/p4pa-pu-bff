...
public interface OperatorRetrieverService {
  ...
  OperatorsDetail findPagedDebtPositionTypeOrg(OperatorDetailsFiltersDTO operatorDetailsFiltersDTO, Pageable pageable, UserInfo loggedUser, String accessToken);
}
