...
import it.gov.pagopa.pu.bff.config.json.jackson3.LocalDateTimeToOffsetDateTimeJackson3Deserializer;
...
public class JsonConfig {
  ...
  private static JacksonModule configureJackson3DateTimeModule() {
    return new tools.jackson.databind.module.SimpleModule()
      // FE requires all date-time fields to be in Europe/Rome LocalDateTime
      .addSerializer(OffsetDateTime.class, new OffsetDateTimeToLocalDateTimeJackson3Serializer())
