...
public class ReceiptViewController implements ReceiptsApi {
  ...
  @Override
  public ResponseEntity<PagedReceiptView> getReceipts(Long organizationId, String receiptOrigin, String operatorExternalUserId, String iuv, String iur, String iud,
                                                      Long debtPositionTypeOrgId, OffsetDateTime fromDate, OffsetDateTime toDate, Pageable pageable) {
