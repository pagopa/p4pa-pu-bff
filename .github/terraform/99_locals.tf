locals {
  ...
  common_tags = {
    ...
    Source      = "https://github.com/pagopa/p4pa-pu-bff" # Repository URL
  ...
  github = {
    org        = "pagopa"
    repository = "p4pa-pu-bff" # Repository Name
  }
  ...
  repo_env = var.env_short == "p" ? {
    SONARCLOUD_PROJECT_NAME = "p4pa-pu-bff"
    SONARCLOUD_PROJECT_KEY  = "pagopa_p4pa-pu-bff"
