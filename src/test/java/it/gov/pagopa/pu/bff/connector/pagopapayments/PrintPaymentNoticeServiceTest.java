...
class PrintPaymentNoticeServiceTest {
  ...
  void whenGenerateNoticeThenInvokeClient() {
    ...
    when(printPaymentNoticeClientMock.generateNotice(organizationId,iuv,debtPositionDTO,
      ACCESS_TOKEN))
      .thenReturn(expectedResult);

    FileResourceDTO result = service.generateNotice(organizationId,iuv,debtPositionDTO,
      ACCESS_TOKEN);
