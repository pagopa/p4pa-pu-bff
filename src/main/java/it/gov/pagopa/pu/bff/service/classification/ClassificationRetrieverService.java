...
public interface ClassificationRetrieverService {
  ...
  PagedModelClassification getClassifications(Long organizationId, ClassificationFiltersDTO filters, Pageable pageable, UserInfo loggedUser, String accessToken);
}
