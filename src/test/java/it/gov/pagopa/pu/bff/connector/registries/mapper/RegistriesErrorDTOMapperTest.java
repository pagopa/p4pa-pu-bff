package it.gov.pagopa.pu.bff.connector.registries.mapper;
...
class RegistriesErrorDTOMapperTest {
  ...
  void whenMapThenReturnPuErrorDTO() {
    ...
    // When
    PuErrorDTO result = RegistriesErrorDTOMapper.map(errorDTO);
    ...
    for (int i = 0; i < fields.size(); i++) {
      ...
      it.gov.pagopa.pu.registries.dto.generated.ErrorFieldDTO expectedErrorFieldDTO = errorDTO.getFields().get(i);
